...
def move(position, instruction, use_cube):
    for _ in range(instruction):
        ...
        if (row, column) not in grid:
            row, column, direction = change_face((row, column, direction), use_cube)
...
def change_face(position, use_cube):
    # Puzzle 2
    if use_cube:
        if is_sample:
            return change_cube_face_for_sample_input(position)
        else:
            return change_cube_face_for_real_input(position)
...
def change_cube_face_for_sample_input(position):
...
def change_cube_face_for_real_input(position):
...
def change_direction(position, instruction):
